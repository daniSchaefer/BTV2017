...
CMS_lumi.lumi_sqrtS = "2017 (13 TeV)" # used with iPeriod = 0, e.g. for simulation-only plots (default is an empty string)
...
canvas.Update()
canvas.SaveAs("EfficiencyCaloJet.pdf")
